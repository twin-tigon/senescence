...
func _on_tween2_tween_completed(_object, _key):
	...
	tween3.interpolate_property($granny, "modulate:a", 0.0, 1.0, 4.0, 1, Tween.EASE_IN, 0)
	tween3.start()
...
func _on_timer_timeout():
	...
	tween2.start()
	tween3.interpolate_property($granny, "modulate:a", 1.0, 0.0, 2.0, 1, Tween.EASE_IN, 0)
	tween3.start()
